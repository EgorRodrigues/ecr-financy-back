...
def test_income_lifecycle(client: TestClient):
    # Create
    payload = {"amount": 5000, "description": "Salary", "status": "recebido", "issue_date": str(date.today())}
...
def test_expense_lifecycle(client: TestClient):
    # Create
    payload = {"amount": 100, "description": "Groceries", "status": "pago", "issue_date": str(date.today())}
